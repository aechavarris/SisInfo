 ...
 */
@WebServlet(description = "Servlet que gestiona solicitudes: Acepta o deniega solicitudes (sea primera decision o modificacion)", urlPatterns = { "/ModificarPCR" })
public class ModificarPCR extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("idPCR") == null)	{
			...
			if(request.getParameter("aceptarMod") != null)	{		// Se ha modificado la solicitud, aceptada
				Integer id = Integer.parseInt(request.getParameter("idPCR"));
				dao.modifyPCR(id, 1);
				request.getRequestDispatcher("RecuperarPCRsProfesional?eleccion=consultarPCRs").forward(request, response);
			}
				...
				Integer id = Integer.parseInt(request.getParameter("idPCR"));
				dao.modifyPCR(id, 1);
				request.getRequestDispatcher("RecuperarPCRsProfesional?eleccion=gestionarPCRs").forward(request, response);
			}
